...
/**
 * 	\file		core/triggers/interface_99_modMyodule_isiworkconnectortrigger.class.php
 * 	\ingroup	isiworkconnector
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modIsiworkconnector_Mytrigger.class.php
 ...
 * Trigger class
 */
class Interfaceisiworkconnectortrigger
{
